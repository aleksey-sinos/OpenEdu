...
h0_var = 10; %Начальная дисперсия оценки высоты %Для заполнения
v_var = 5; %Начальная дисперсия оценки скорости %Для заполнения

%Дисперсия измерителей
SNS_var = 2;                                    %Для заполнения
BAR_var = 5;                                    %Для заполнения
